...
- (void)_commonInit
{
    ...
    // Add default action.
    UIImage *dismissImage = [UIImage imageNamed:@"MMNumberKeyboardDismissKey" inBundle:SWIFTPM_MODULE_BUNDLE compatibleWithTraitCollection: nil];
...
- (void)_configureButtonsForCurrentStyle
{
    ...
    UIImage *backspaceImage = [UIImage imageNamed:@"MMNumberKeyboardDeleteKey" inBundle:SWIFTPM_MODULE_BUNDLE compatibleWithTraitCollection: nil];
